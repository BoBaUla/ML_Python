from RandomWalkNumberGenerator import RandomWalker as RW
from PlottingCollection import plotData
from mathHelper import returnFromDataRelativ as relativeGrowth
from PreEvaluation import getSubset
